...
$emailEnable = $true
$emailFrom = "itnotify@primaryasset.co.za"
$emailTo = "itnotify@primaryasset.co.za"
$emailSubject = "VMware Health Check"
$emailServer = "primaryasset-co-za.mail.protection.outlook.com"
